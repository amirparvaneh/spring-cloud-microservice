...
public class TransferTransaction implements TransactionStrategy {
    ...
    private static final Logger log = LoggerFactory.getLogger(TransferTransaction.class);
    ...
    public TransactionResponseDto sendRequestToTransactionMicroservice(TransactionRequestDto transactionRequestDto) {
        ...
        TransactionResponseDto transactionResponseDto = transactionMicroFeign.transfer(transactionRequestDto);
