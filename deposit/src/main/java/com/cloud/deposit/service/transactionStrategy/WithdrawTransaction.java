...
public class WithdrawTransaction implements TransactionStrategy {
    ...
    private static final Logger log = LoggerFactory.getLogger(WithdrawTransaction.class);
    ...
    public TransactionResponseDto sendRequestToTransactionMicroservice(TransactionRequestDto transactionRequestDto) {
        ...
        TransactionResponseDto transactionResponseDto = transactionMicroFeign.withdrawAmount(transactionRequestDto);
